...
locations[3][1].add_description("You are now standing outside the house. You see a path in the East")
locations[3][2].add_description("There is a path heading towards the South. Follow it")
locations[2][2].add_description("You have walked for hours, but the path goes on...")
locations[1][2].add_description("You are standing in front of a dark forest.")
locations[1][3].add_description("You hear some noises to your East.")
...
locations[0][1].add_description("There is something to your North, go there.")
locations[1][1].add_description("You found a chest, would you like get the items from the chest?")
locations[0][2].add_description("You are in the middle of a dark forest, you can only go back...")
...
def help_file():
    ...
    time.sleep(1)
    print("If you need a description of the location where you are enter 'l'.")
    time.sleep(1)
